                    ...
                    <div class="col-lg-4 col-6">
                        <div class="single-product">
                            ...
                            @else
                                ...
                                @else
                                     <a class="btn btn-brand pre-oreder-modal-toggler" href="javascript:;" data-target="pre-oreder-modal" data-title="{{$Product->title}}" data-sku="{{$Product->sku}}"><i class="fas fa-cart-plus"></i> Pre Order</a>
                                @endif
                            @endif
                        </div>
                    </div>
